...
session = DBSession()
# Create dummy user
User1 = User(name="Saurabh Jain", email="saurabhjn76@gmail.com",
             picture='https://pbs.twimg.com/profile_images/861502404952567810/FRwmKg6R_400x400.jpg')
session.add(User1)
session.commit()
...
sportsplayer1 = SportsPlayer(user_id=1, name="Viktor AXELSEN", description="Viktor Axelsen (born January 4, 1994) is a Danish badminton player and the current"
...
sportsplayer2 = SportsPlayer(user_id=1, name="SON Wan Ho", description="Son Wan-ho is a South Korean badminton player. He competed in the singles event at the "
...
sportsplayer3 = SportsPlayer(user_id=1, name="LIN Dan", description="Lin Dan is a Chinese professional badminton player. He is a two-time Olympic champion, "
...
sportsplayer4 = SportsPlayer(user_id=1, name="SHI Yuqi", description="Shi Yuqi is a Chinese male badminton player. He won the France SuperSeries 2016 champion"
...
sportsplayer5 = SportsPlayer(user_id=1, name="CHOU Tien Chen", description="Chou Tien-chen is a male badminton player from Taiwan, representing Chinese Taipei."
...
sportsplayer6 = SportsPlayer(user_id=1, name="CHEN Long", description="Chen Long, nicknamed 'Junior Lin Dan / Little Dan', is a Chinese professional badminton player. He is the "
...
sportsplayer7 = SportsPlayer(user_id=1, name="LEE Chong Wei", description="Dato' Lee Chong Wei DSPN DB DCSM PJN is a Chinese-Malaysian professional badminton player. As a singles"
...
sportsplayer8 = SportsPlayer(user_id=1, name="KIDAMBI Srikanth", description="Srikanth Kidambi is an Indian badminton player. He shot to prominence by defeating Olympic Champion"
...
sportsplayer9 = SportsPlayer(user_id=1, name="NG Ka Long Angus", description="Angus Ng Ka Long is a badminton player from Hong Kong. He has a career-high ranking of 9 in Men's "
...
sportsplayer1 = SportsPlayer(user_id=1, name="Carlsen, Magnus", description=" Norwegian chess grandmaster and the current World Chess Champion. A chess prodigy, Carlsen earned his "
...
sportsplayer2 = SportsPlayer(user_id=1, name="Aronian, Levon", description=" Levon Grigori Aronian is an Armenian chess Grandmaster. On the March 2014 FIDE rating list,"
...
sportsplayer3 = SportsPlayer(user_id=1, name="Vachier-Lagrave, Maxime", description="Maxime Vachier-Lagrave is a French chess grandmaster. He was World Junior Champion in "
...
sportsplayer4 = SportsPlayer(user_id=1, name="Caruana, Fabiano", description="Fabiano Luigi Caruana is an Italian-American chess grandmaster. He played for the United States until 2005, "
...
sportsplayer5 = SportsPlayer(user_id=1, name="Kramnik, Vladimir", description="Vladimir Borisovich Kramnik is a Russian chess grandmaster. He was the Classical World Chess Champion from "
...
sportsplayer6 = SportsPlayer(user_id=1, name="Anand, Viswanathan", description="Viswanathan 'Vishy' Anand is an Indian chess grandmaster and a former World "
...
sportsplayer1 = SportsPlayer(user_id=1, name="MA Long", description="aMa Long is a Chinese table tennis player. The current Olympic and World Champion, he is"
...
sportsplayer2 = SportsPlayer(user_id=1, name="FAN Zhendong", description="Fan Zhendong is a Chinese table tennis player. He is ranked number 2 in the official ITTF world rankings as of January 2017.",
                     rank="2", country="China", sports=sports3)

session.add(sportsplayer2)
session.commit()

sportsplayer3 = SportsPlayer(user_id=1, name="XU Xin", description="Xu Xin is a Chinese table tennis player and is currently the No. 3 ranked player in the world, as of July 2016.",
                     rank="3", country="China", sports=sports3)

session.add(sportsplayer3)
session.commit()

sportsplayer4 = SportsPlayer(user_id=1, name="OVTCHAROV Dimitrij", description="Dimitrij Ovtcharov or Dmytro Ovtcharov is a Ukrainian-born German table"
...
sportsplayer5 = SportsPlayer(user_id=1, name="BOLL Timo", description="Timo Boll is a German professional table tennis player who currently plays with "
...
sportsplayer1 = SportsPlayer(user_id=1, name="AB de Villiers", description="AB de Villiers is a South African cricketer, who plays all formats and"
...
sportsplayer2 = SportsPlayer(user_id=1, name="Virat Kohli", description="Pan Indian international cricketer who currently captains the India national team."
...
sportsplayer3 = SportsPlayer(user_id=1, name="Kane Williamson", description="Kane Stuart Williamson is a professional cricketer and currently the captain of New Zealand."
...
sportsplayer4 = SportsPlayer(user_id=1, name="Tillekeratne Dilshan", description="Tillakaratne Mudiyanselage Dilshan, popularly known as Tillakaratne Dilshan, is a former"
...
sportsplayer5 = SportsPlayer(user_id=1, name="Hashim Amla", description="Hashim Muhammad Amla is a South African cricketer who plays for South Africa in all "
...
sportsplayer6 = SportsPlayer(user_id=1, name="MS Dhoni", description="Mahendra Singh Dhoni is an Indian cricketer who captained the Indian team in limited-overs"
