...
sportsplayer2 = SportsPlayer(user_id=1, name="SON Wan Ho",
...
sportsplayer3 = SportsPlayer(user_id=1, name="LIN Dan",
...
sportsplayer4 = SportsPlayer(user_id=1, name="SHI Yuqi",
...
sportsplayer5 = SportsPlayer(user_id=1, name="CHOU Tien Chen",
...
sportsplayer6 = SportsPlayer(user_id=1, name="CHEN Long",
...
sportsplayer7 = SportsPlayer(user_id=1, name="LEE Chong Wei",
...
sportsplayer8 = SportsPlayer(user_id=1, name="KIDAMBI Srikanth",
...
sportsplayer9 = SportsPlayer(user_id=1, name="NG Ka Long Angus",
...
sportsplayer3 = SportsPlayer(user_id=1, name="Vachier-Lagrave, Maxime",
...
sportsplayer4 = SportsPlayer(user_id=1, name="Caruana, Fabiano",
...
sportsplayer5 = SportsPlayer(user_id=1, name="Kramnik, Vladimir",
...
sportsplayer6 = SportsPlayer(user_id=1, name="Anand, Viswanathan",
...
sportsplayer1 = SportsPlayer(user_id=1, name="MA Long",
...
sportsplayer2 = SportsPlayer(user_id=1, name="FAN Zhendong",
...
sportsplayer3 = SportsPlayer(user_id=1, name="XU Xin",
...
sportsplayer4 = SportsPlayer(user_id=1, name="OVTCHAROV Dimitrij",
...
sportsplayer5 = SportsPlayer(user_id=1, name="BOLL Timo",
...
sportsplayer3 = SportsPlayer(user_id=1, name="Kane Williamson",
...
sportsplayer4 = SportsPlayer(user_id=1, name="Tillekeratne Dilshan",
...
sportsplayer5 = SportsPlayer(user_id=1, name="Hashim Amla",
...
sportsplayer6 = SportsPlayer(user_id=1, name="MS Dhoni",
